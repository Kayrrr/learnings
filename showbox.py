# -*- coding: utf-8 -*-
"""
Created on Mon Aug  6 15:09:34 2018
...
#from build_cgd_dataset import _process_bboxes
import cv2

filename = 'D:/Grasp/10/pcd1020r.png'
...
if __name__ == '__main__':
    ...
    cv2.rectangle(img_show,(int(box[0][0]),int(box[0][1])),(int(box[2][0]),int(box[2][1])),(0,255,0))
